      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/universities" className="text-sm font-medium text-brand-blue transition-colors">For Universities</Link>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <motion.div initial="hidden" animate="show" variants={stagger}>
            ...
            <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl font-extrabold text-brand-navy leading-tight mb-6 max-w-4xl mx-auto tracking-tight">
              ...
              <span className="text-brand-blue">Campus and Corporate</span>
            </motion.h1>

            <motion.p variants={fadeUp} className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
              Equip your students with the exact skills top employers hire for. Our AI-driven simulations map directly to real-world corporate competencies.
            </motion.p>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
              ...
              >
                Request University Demo <ArrowRight className="w-5 h-5" />
              </Link>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: BookOpen,
                title: "Embed in Curriculum",
                description: "Easily integrate our 8-pillar Corporate Readiness Score into capstone courses or career prep workshops.",
              },
              {
                icon: BarChart3,
                title: "Track Competency",
                description: "Gain macro visibility into your student body's readiness. Understand where your cohorts excel and where they need support.",
              },
              {
                icon: Building2,
                title: "Improve Placement Rates",
                description: "Provide proprietary employer-grade screening analytics that give your students a competitive edge in interviews.",
              },
            ].map((feature, idx) => (
              <div
                key={idx}
